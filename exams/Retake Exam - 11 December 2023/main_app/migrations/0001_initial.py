# Generated by Django 5.0.4 on 2024-08-02 08:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('players', models.ManyToManyField(related_name='tennis_player_matches', to='main_app.tennisplayer')),
                ('winner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='winner_matches', to='main_app.tennisplayer')),
                ('tournament', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tournament_matches', to='main_app.tournament')),
            ],
            options={
