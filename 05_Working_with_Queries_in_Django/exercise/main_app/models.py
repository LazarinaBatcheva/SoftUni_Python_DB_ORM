...
from main_app.choices import MealTypeChoice, DungeonDifficultyChoice, WorkoutTypeChoice, LaptopBrandChoice, \
    LaptopOperationSystemChoice
...
class Laptop(models.Model):
    ...
    operation_system = models.CharField(
        max_length=30,
        choices=LaptopOperationSystemChoice.choices,
    )
