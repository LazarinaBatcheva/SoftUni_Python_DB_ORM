...
from main_app.validators import validate_name_only_letters_spaces
...
class Customer(models.Model):
    name = models.CharField(
        max_length=100,
        validators=[
            validate_name_only_letters_spaces,
...
class Hero(models.Model, RechargeEnergyMixin):
    ...
    energy = models.PositiveIntegerField()  # the energy should always remain positive integer
